...
```bash
git clone https://github.com/<USERNAME>/babel-plugin-react-code-block.git
cd babel-plugin-react-code-block
git remote add upstream https://github.com/dogma-io/babel-plugin-react-code-block.git
```

**SSH**

```bash
git clone git@github.com:<USERNAME>/babel-plugin-react-code-block.git
cd babel-plugin-react-code-block
git remote add upstream git@github.com:dogma-io/babel-plugin-react-code-block.git
```
...
npm run build && $(npm bin)/jest # unit tests
```
...
yarn run build && yarn run jest # unit tests
```
...
[fork-repo]: https://github.com/dogma-io/babel-plugin-react-code-block#fork-destination-box
